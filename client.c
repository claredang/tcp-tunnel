...
int main(int argc, char **argv)
{
    ...
    if (argc == 3)
    {
        ...
        // ===== 1.0. getaddrinfo: IP address -> server name
        ...
        // =====  1.1. getnameinfo: server name -> IP address
        ...
        // ===== 2. Establish socket and print server message
    ...
    else if (argc == 5)
    {
        ...
        // ===== 1.1 getaddrinfo: IP address -> server name
        struct addrinfo *res = NULL;
        ...
        // =====  1.2. getnameinfo: server name -> IP address
        struct sockaddr_in sa;
        char node[NI_MAXHOST];
